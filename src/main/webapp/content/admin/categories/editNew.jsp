...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/content/admin/categories/js/editNew.js"></script>	
]]>
...
<body>
	...
	<s:form autocomplete="off" id="frmCategoria" theme="simple"
		action="%{#pageContext.request.contextPath}/categories" onsubmit="prepararEnvio()" method="post">
